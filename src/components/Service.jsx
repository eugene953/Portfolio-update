...
const services = [
 ...
 },
 {
    ...
    description:"Server-side logic and database development.",
 },
 {
    id:6,
...
const Service = () => {
  return (
    <div className='border-b border-neutral-900 pb-4 lg:mb-35 py-20' id='service'>
    <div className=" mx-auto px-8 md:px-16 lg:px-24">
     <h2 className='text-4xl font-bold text-center
     mb-12'> My Services</h2>
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3
     gap-8">
     {services.map((service) => (
        <div 
        key={service.id}
         className="bg-gray-800 px-6 pb-6 hover:shadow-lg rounded-lg
           transform transition-transform duration-300 hover:scale-105 "
          >
            <div 
            className=" text-right text-2xl font-bold text-transparent 
